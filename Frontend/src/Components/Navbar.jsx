        ...
        <>
            <div className="navbar flex items-center justify-between px-[100px] h-[80px] bg-[#141414]">
                ...
                <div className="links flex items-center gap-2">
                    ...
                    <Avatar onClick={() => { setIsDropDownShow(!isDropDownShow); }} name={data ? data.name : ""} size="40" round="50%" className="cursor-pointer ml-2"></Avatar>
                </div>

                {isDropDownShow ? <div className='dropDownNavbar absolute right-[60px] top-[80px] shadow-lg/50 p-[10px] bg-[#1A1919] w-[150px] h-[160px]'>
