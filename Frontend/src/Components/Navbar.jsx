...
const Navbar = ({ isGridLayout, setIsGridLayout }) => {
    ...
    return (
        <>
            <div className={`navbar flex items-center justify-between px-[100px] h-[80px] ${isLightMode ? "bg-[#f4f4f4]" : "bg-[#141414]"}`}>
                <div className="logo">
                ...
                <div className={`dropDownNavbar hidden absolute right-[60px] top-[80px] shadow-lg/50 p-[10px] ${isLightMode ? "bg-[#f4f4f4]" : "bg-[#1A1919]"} w-[150px] h-[160px]`}>
                    <div className={`py-[10px] border-b-[1px] ${isLightMode ? "border-b-[#000]" : "border-b-[#fff]"}`}>
                        <h3 className="text-[17px]" style={{ lineHeight: 1 }}>{data ? data.name : ""}</h3>
                    </div>
                    <i onClick={toggleTheme} className="flex items-center gap-2 mt-3 mb-2 cursor-pointer" style={{ fontStyle: "normal" }}>
