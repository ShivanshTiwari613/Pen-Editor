...
const Home = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="flex item-center justify-between px-[100px] my-[40px]">
                <h2 className="text-2xl"> Welome to Coding </h2>
...

            {
                ...
                <div className="createModel w-[25vw] h-[27vh] shadow-lg shadow-black/50 bg-[#141414] rounded-[10px] p-[20px]">
                    ...
                    <div className="flex items-center gap-[10px] w-full mt-2">
                        <button className="btnBlue rounded-[5px] w-[49%] mb-4 text-[20px] !p-[5px] !p-[10px] !py-[10px]">Create</button>
